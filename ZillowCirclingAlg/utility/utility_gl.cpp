...
GLuint Utility::loadTexture(const vector<vector<vector<GLubyte>>> data, GLuint filteringParam)
{
	...
	GLubyte * temp = new GLubyte[h * w * 4];
...
FrameBufferObject Utility::createFrameBufferObject(int width, int height)
{
	...
	cout << "createFrameBufferObject " << endl;
